...
public class WebClientImpl {
    ...
    public ClientResponseDto create(ClientRequestDto requestDto) throws URISyntaxException, IOException, InterruptedException {
    ...
    public ClientResponseDto updateClient(Long id, ClientRequestDto requestDto) throws URISyntaxException, IOException, InterruptedException {
        if (id == null) {
    ...
    public void deleteClient(Long id) throws URISyntaxException, IOException, InterruptedException {
        if (id == null) {
            throw new IllegalArgumentException("Id cannot be null");
        }
        HttpRequest request = HttpRequest.newBuilder(new URI(COMMON_URI + "/clients/" + id))
